<section class="results" id="non-logged">
  <div class="aos-init aos-animate" data-aos="fade-down" align="center">
    <p align="center"><h4 style="color: #3f464e"> <?= $category_name ?></h4></p>

    <div class="container no-results" align="center" style="display: none;">
...
<?php if ($page_num > 1): ?>
  <a href='category.php?k=<?=$category?>&p=<?=$page_num-1?>#'> &#9001; </a>
<?php endif ?>  
  <?php for ($i = 1; $i<count($page_links); $i++): ?>
    <a href='category.php?k=<?=$category ?>&p=<?=$i ?>#' <?php if (isset($_GET['p'])  && $_GET['p'] == $i ) { echo  "class='active'";}    ?> > <?=$i ?> </a> 
  <?php endfor?>
...
<section class="main container row" style="margin:auto; margin-top: -8%">
    <div class="container no-results" align="center">
      <img src="css/img/stitch-sorry.gif" width="500">
      <br>
      <h5 style="text-transform: none; font-weight: 100;">Sorry no ad for this category yet<br> <a href="index.php">Continue</a> </h5>
    </div>
</section>  
